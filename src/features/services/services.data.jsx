export const services = [
  {
    ...
    description: "Build simple backend logic for web applications.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description: "Create small web apps as learning projects.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  },
  {
    ...
    description: "Build basic websites with frontend & backend.",
    icon: (
      <svg
        width="24"
        height="24"
